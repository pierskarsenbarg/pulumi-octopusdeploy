...
namespace Pulumi.Octopusdeploy
{
    public static class GetCloudRegionDeploymentTargets
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCloudRegionDeploymentTargetsResult> InvokeAsync(GetCloudRegionDeploymentTargetsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudRegionDeploymentTargetsResult>("octopusdeploy:index/getCloudRegionDeploymentTargets:getCloudRegionDeploymentTargets", args ?? new GetCloudRegionDeploymentTargetsArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<GetCloudRegionDeploymentTargetsResult> Invoke(GetCloudRegionDeploymentTargetsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudRegionDeploymentTargetsResult>("octopusdeploy:index/getCloudRegionDeploymentTargets:getCloudRegionDeploymentTargets", args ?? new GetCloudRegionDeploymentTargetsInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetCloudRegionDeploymentTargetsArgs : global::Pulumi.InvokeArgs
    {
        [Input("cloudRegionDeploymentTargets")]
        private List<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs>? _cloudRegionDeploymentTargets;

        /// <summary>
        /// A list of cloud region deployment targets that match the filter(s).
        /// </summary>
        public List<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs> CloudRegionDeploymentTargets
        {
            get => _cloudRegionDeploymentTargets ?? (_cloudRegionDeploymentTargets = new List<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs>());
            set => _cloudRegionDeploymentTargets = value;
        }
        ...
        public GetCloudRegionDeploymentTargetsArgs()
        {
        }
        public static new GetCloudRegionDeploymentTargetsArgs Empty => new GetCloudRegionDeploymentTargetsArgs();
    }

    public sealed class GetCloudRegionDeploymentTargetsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("cloudRegionDeploymentTargets")]
        private InputList<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetInputArgs>? _cloudRegionDeploymentTargets;

        /// <summary>
        /// A list of cloud region deployment targets that match the filter(s).
        /// </summary>
        public InputList<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetInputArgs> CloudRegionDeploymentTargets
        {
            get => _cloudRegionDeploymentTargets ?? (_cloudRegionDeploymentTargets = new InputList<Inputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetInputArgs>());
            set => _cloudRegionDeploymentTargets = value;
        }
        ...
        public GetCloudRegionDeploymentTargetsInvokeArgs()
        {
        }
        public static new GetCloudRegionDeploymentTargetsInvokeArgs Empty => new GetCloudRegionDeploymentTargetsInvokeArgs();
    }


    [OutputType]
    public sealed class GetCloudRegionDeploymentTargetsResult
    {
        /// <summary>
        /// A list of cloud region deployment targets that match the filter(s).
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetResult> CloudRegionDeploymentTargets;
        /// <summary>
        /// A filter to search by deployment ID.
        /// </summary>
        ...
        [OutputConstructor]
        private GetCloudRegionDeploymentTargetsResult(
            ImmutableArray<Outputs.GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetResult> cloudRegionDeploymentTargets,
            ...
            string? thumbprint)
        {
            CloudRegionDeploymentTargets = cloudRegionDeploymentTargets;
