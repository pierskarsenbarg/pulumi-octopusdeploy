...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepRunScriptActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepRunScriptActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepRunScriptActionContainerGetArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepRunScriptActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepRunScriptActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepRunScriptActionPackageGetArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepRunScriptActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepRunScriptActionPackageGetArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.DeploymentProcessStepRunScriptActionPrimaryPackageGetArgs>? PrimaryPackage { get; set; }
        ...
        public DeploymentProcessStepRunScriptActionGetArgs()
        {
        }
        public static new DeploymentProcessStepRunScriptActionGetArgs Empty => new DeploymentProcessStepRunScriptActionGetArgs();
    }
}
