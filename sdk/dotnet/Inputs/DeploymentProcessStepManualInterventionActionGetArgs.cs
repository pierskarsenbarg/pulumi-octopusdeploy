...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepManualInterventionActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepManualInterventionActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepManualInterventionActionContainerGetArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepManualInterventionActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepManualInterventionActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepManualInterventionActionPackageGetArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepManualInterventionActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepManualInterventionActionPackageGetArgs>());
            set => _packages = value;
        }
        ...
        public DeploymentProcessStepManualInterventionActionGetArgs()
        {
        }
        public static new DeploymentProcessStepManualInterventionActionGetArgs Empty => new DeploymentProcessStepManualInterventionActionGetArgs();
    }
}
