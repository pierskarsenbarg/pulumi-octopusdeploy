...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetDestinationInputArgs>? _destinations;
        public InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetDestinationInputArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetDestinationInputArgs>());
            set => _destinations = value;
        }

        [Input("endpoints", required: true)]
        private InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetEndpointInputArgs>? _endpoints;
        public InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetEndpointInputArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetEndpointInputArgs>());
        ...
        public GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetInputArgs()
        {
        }
        public static new GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetInputArgs Empty => new GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetInputArgs();
    }
}
