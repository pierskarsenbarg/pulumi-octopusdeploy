...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepDeployKubernetesSecretActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepDeployKubernetesSecretActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionContainerGetArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionPackageGetArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepDeployKubernetesSecretActionPackageGetArgs>());
            set => _packages = value;
        }
        ...
        public DeploymentProcessStepDeployKubernetesSecretActionGetArgs()
        {
        }
        public static new DeploymentProcessStepDeployKubernetesSecretActionGetArgs Empty => new DeploymentProcessStepDeployKubernetesSecretActionGetArgs();
    }
}
