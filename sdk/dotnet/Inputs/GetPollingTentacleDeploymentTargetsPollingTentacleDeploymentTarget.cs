...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetArgs : global::Pulumi.InvokeArgs
    {
        ...
        private List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetEndpointArgs>? _endpoints;
        public List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetEndpointArgs>());
        ...
        private List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetTentacleVersionDetailArgs>? _tentacleVersionDetails;
        public List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetTentacleVersionDetailArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new List<Inputs.GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetTentacleVersionDetailArgs>());
        ...
        public GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetArgs()
        {
        }
        public static new GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetArgs Empty => new GetPollingTentacleDeploymentTargetsPollingTentacleDeploymentTargetArgs();
    }
}
