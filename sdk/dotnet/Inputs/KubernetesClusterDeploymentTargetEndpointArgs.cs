...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class KubernetesClusterDeploymentTargetEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.KubernetesClusterDeploymentTargetEndpointAuthenticationArgs>? Authentication { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.KubernetesClusterDeploymentTargetEndpointContainerArgs>? _containers;
        public InputList<Inputs.KubernetesClusterDeploymentTargetEndpointContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.KubernetesClusterDeploymentTargetEndpointContainerArgs>());
        ...
        [Input("destinations")]
        private InputList<Inputs.KubernetesClusterDeploymentTargetEndpointDestinationArgs>? _destinations;
        public InputList<Inputs.KubernetesClusterDeploymentTargetEndpointDestinationArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.KubernetesClusterDeploymentTargetEndpointDestinationArgs>());
        ...
        private InputList<Inputs.KubernetesClusterDeploymentTargetEndpointTentacleVersionDetailArgs>? _tentacleVersionDetails;
        public InputList<Inputs.KubernetesClusterDeploymentTargetEndpointTentacleVersionDetailArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new InputList<Inputs.KubernetesClusterDeploymentTargetEndpointTentacleVersionDetailArgs>());
        ...
        public KubernetesClusterDeploymentTargetEndpointArgs()
        {
        }
        public static new KubernetesClusterDeploymentTargetEndpointArgs Empty => new KubernetesClusterDeploymentTargetEndpointArgs();
    }
}
