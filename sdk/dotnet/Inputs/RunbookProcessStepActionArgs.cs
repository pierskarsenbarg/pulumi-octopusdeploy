...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class RunbookProcessStepActionArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.RunbookProcessStepActionActionTemplateArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.RunbookProcessStepActionContainerArgs>? _containers;
        public InputList<Inputs.RunbookProcessStepActionContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.RunbookProcessStepActionContainerArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.RunbookProcessStepActionPackageArgs>? _packages;
        public InputList<Inputs.RunbookProcessStepActionPackageArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.RunbookProcessStepActionPackageArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.RunbookProcessStepActionPrimaryPackageArgs>? PrimaryPackage { get; set; }
        ...
        public RunbookProcessStepActionArgs()
        {
        }
        public static new RunbookProcessStepActionArgs Empty => new RunbookProcessStepActionArgs();
    }
}
