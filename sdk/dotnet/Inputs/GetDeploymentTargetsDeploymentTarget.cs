...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class GetDeploymentTargetsDeploymentTargetArgs : global::Pulumi.InvokeArgs
    {
        [Input("endpoints", required: true)]
        private List<Inputs.GetDeploymentTargetsDeploymentTargetEndpointArgs>? _endpoints;
        public List<Inputs.GetDeploymentTargetsDeploymentTargetEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new List<Inputs.GetDeploymentTargetsDeploymentTargetEndpointArgs>());
        ...
        public GetDeploymentTargetsDeploymentTargetArgs()
        {
        }
        public static new GetDeploymentTargetsDeploymentTargetArgs Empty => new GetDeploymentTargetsDeploymentTargetArgs();
    }
}
