...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepRunKubectlScriptActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepRunKubectlScriptActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerGetArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageGetArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageGetArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.DeploymentProcessStepRunKubectlScriptActionPrimaryPackageGetArgs>? PrimaryPackage { get; set; }
        ...
        public DeploymentProcessStepRunKubectlScriptActionGetArgs()
        {
        }
        public static new DeploymentProcessStepRunKubectlScriptActionGetArgs Empty => new DeploymentProcessStepRunKubectlScriptActionGetArgs();
    }
}
