...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("accountId", required: true)]
        public Input<string> AccountId { get; set; } = null!;

        [Input("endpoints", required: true)]
        private InputList<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointInputArgs>? _endpoints;
        public InputList<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointInputArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointInputArgs>());
        ...
        [Input("webAppSlotName", required: true)]
        public Input<string> WebAppSlotName { get; set; } = null!;

        public GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetInputArgs()
        {
        }
        public static new GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetInputArgs Empty => new GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetInputArgs();
    }
}
