...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class GetDeploymentTargetsDeploymentTargetInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("endpoints", required: true)]
        private InputList<Inputs.GetDeploymentTargetsDeploymentTargetEndpointInputArgs>? _endpoints;
        public InputList<Inputs.GetDeploymentTargetsDeploymentTargetEndpointInputArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.GetDeploymentTargetsDeploymentTargetEndpointInputArgs>());
        ...
        public GetDeploymentTargetsDeploymentTargetInputArgs()
        {
        }
        public static new GetDeploymentTargetsDeploymentTargetInputArgs Empty => new GetDeploymentTargetsDeploymentTargetInputArgs();
    }
}
