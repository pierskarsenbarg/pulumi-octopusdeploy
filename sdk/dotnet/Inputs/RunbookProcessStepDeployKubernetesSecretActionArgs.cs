...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class RunbookProcessStepDeployKubernetesSecretActionArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.RunbookProcessStepDeployKubernetesSecretActionActionTemplateArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerArgs>? _containers;
        public InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageArgs>? _packages;
        public InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageArgs>());
            set => _packages = value;
        }
        ...
        public RunbookProcessStepDeployKubernetesSecretActionArgs()
        {
        }
        public static new RunbookProcessStepDeployKubernetesSecretActionArgs Empty => new RunbookProcessStepDeployKubernetesSecretActionArgs();
    }
}
