...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs : global::Pulumi.InvokeArgs
    {
        [Input("accountId", required: true)]
        public string AccountId { get; set; } = null!;

        [Input("endpoints", required: true)]
        private List<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointArgs>? _endpoints;
        public List<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new List<Inputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetEndpointArgs>());
        ...
        public string WebAppName { get; set; } = null!;

        [Input("webAppSlotName", required: true)]
        public string WebAppSlotName { get; set; } = null!;

        public GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs()
        {
        }
        public static new GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs Empty => new GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs();
    }
}
