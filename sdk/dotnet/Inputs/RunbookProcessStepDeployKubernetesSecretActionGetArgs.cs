...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class RunbookProcessStepDeployKubernetesSecretActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.RunbookProcessStepDeployKubernetesSecretActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerGetArgs>? _containers;
        public InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageGetArgs>? _packages;
        public InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.RunbookProcessStepDeployKubernetesSecretActionPackageGetArgs>());
            set => _packages = value;
        }
        ...
        public RunbookProcessStepDeployKubernetesSecretActionGetArgs()
        {
        }
        public static new RunbookProcessStepDeployKubernetesSecretActionGetArgs Empty => new RunbookProcessStepDeployKubernetesSecretActionGetArgs();
    }
}
