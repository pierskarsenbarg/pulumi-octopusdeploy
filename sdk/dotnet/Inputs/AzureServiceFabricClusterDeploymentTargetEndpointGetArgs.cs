...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class AzureServiceFabricClusterDeploymentTargetEndpointGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointAuthenticationGetArgs>? Authentication { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerGetArgs>? _containers;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerGetArgs>());
        ...
        [Input("destinations")]
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationGetArgs>? _destinations;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationGetArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationGetArgs>());
        ...
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailGetArgs>? _tentacleVersionDetails;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailGetArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailGetArgs>());
        ...
        public AzureServiceFabricClusterDeploymentTargetEndpointGetArgs()
        {
        }
        public static new AzureServiceFabricClusterDeploymentTargetEndpointGetArgs Empty => new AzureServiceFabricClusterDeploymentTargetEndpointGetArgs();
    }
}
