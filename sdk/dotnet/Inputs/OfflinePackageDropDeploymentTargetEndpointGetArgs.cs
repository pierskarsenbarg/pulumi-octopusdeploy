...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class OfflinePackageDropDeploymentTargetEndpointGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.OfflinePackageDropDeploymentTargetEndpointAuthenticationGetArgs>? Authentication { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerGetArgs>? _containers;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerGetArgs>());
        ...
        [Input("destinations")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationGetArgs>? _destinations;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationGetArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationGetArgs>());
        ...
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailGetArgs>? _tentacleVersionDetails;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailGetArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailGetArgs>());
        ...
        public OfflinePackageDropDeploymentTargetEndpointGetArgs()
        {
        }
        public static new OfflinePackageDropDeploymentTargetEndpointGetArgs Empty => new OfflinePackageDropDeploymentTargetEndpointGetArgs();
    }
}
