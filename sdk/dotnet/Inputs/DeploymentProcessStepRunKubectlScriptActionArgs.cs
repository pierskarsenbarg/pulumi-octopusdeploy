...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepRunKubectlScriptActionArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepRunKubectlScriptActionActionTemplateArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionContainerArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepRunKubectlScriptActionPackageArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.DeploymentProcessStepRunKubectlScriptActionPrimaryPackageArgs>? PrimaryPackage { get; set; }
        ...
        public DeploymentProcessStepRunKubectlScriptActionArgs()
        {
        }
        public static new DeploymentProcessStepRunKubectlScriptActionArgs Empty => new DeploymentProcessStepRunKubectlScriptActionArgs();
    }
}
