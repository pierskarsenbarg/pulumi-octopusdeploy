...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class DeploymentProcessStepActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.DeploymentProcessStepActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.DeploymentProcessStepActionContainerGetArgs>? _containers;
        public InputList<Inputs.DeploymentProcessStepActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.DeploymentProcessStepActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.DeploymentProcessStepActionPackageGetArgs>? _packages;
        public InputList<Inputs.DeploymentProcessStepActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.DeploymentProcessStepActionPackageGetArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.DeploymentProcessStepActionPrimaryPackageGetArgs>? PrimaryPackage { get; set; }
        ...
        public DeploymentProcessStepActionGetArgs()
        {
        }
        public static new DeploymentProcessStepActionGetArgs Empty => new DeploymentProcessStepActionGetArgs();
    }
}
