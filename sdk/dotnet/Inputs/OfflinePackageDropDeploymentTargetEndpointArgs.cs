...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class OfflinePackageDropDeploymentTargetEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.OfflinePackageDropDeploymentTargetEndpointAuthenticationArgs>? Authentication { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerArgs>? _containers;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointContainerArgs>());
        ...
        [Input("destinations")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationArgs>? _destinations;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointDestinationArgs>());
        ...
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailArgs>? _tentacleVersionDetails;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointTentacleVersionDetailArgs>());
        ...
        public OfflinePackageDropDeploymentTargetEndpointArgs()
        {
        }
        public static new OfflinePackageDropDeploymentTargetEndpointArgs Empty => new OfflinePackageDropDeploymentTargetEndpointArgs();
    }
}
