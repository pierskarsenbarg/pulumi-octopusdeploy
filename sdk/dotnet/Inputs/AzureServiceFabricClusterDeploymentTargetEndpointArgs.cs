...
namespace PiersKarsenbarg.Octopusdeploy.Inputs
{
    ...
    public sealed class AzureServiceFabricClusterDeploymentTargetEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointAuthenticationArgs>? Authentication { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerArgs>? _containers;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointContainerArgs>());
        ...
        [Input("destinations")]
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationArgs>? _destinations;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointDestinationArgs>());
        ...
        private InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailArgs>? _tentacleVersionDetails;
        public InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailArgs> TentacleVersionDetails
        {
            get => _tentacleVersionDetails ?? (_tentacleVersionDetails = new InputList<Inputs.AzureServiceFabricClusterDeploymentTargetEndpointTentacleVersionDetailArgs>());
        ...
        public AzureServiceFabricClusterDeploymentTargetEndpointArgs()
        {
        }
        public static new AzureServiceFabricClusterDeploymentTargetEndpointArgs Empty => new AzureServiceFabricClusterDeploymentTargetEndpointArgs();
    }
}
