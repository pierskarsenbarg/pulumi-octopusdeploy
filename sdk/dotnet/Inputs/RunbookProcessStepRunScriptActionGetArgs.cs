...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class RunbookProcessStepRunScriptActionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionTemplate")]
        public Input<Inputs.RunbookProcessStepRunScriptActionActionTemplateGetArgs>? ActionTemplate { get; set; }
        ...
        [Input("containers")]
        private InputList<Inputs.RunbookProcessStepRunScriptActionContainerGetArgs>? _containers;
        public InputList<Inputs.RunbookProcessStepRunScriptActionContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.RunbookProcessStepRunScriptActionContainerGetArgs>());
        ...
        [Input("packages")]
        private InputList<Inputs.RunbookProcessStepRunScriptActionPackageGetArgs>? _packages;
        public InputList<Inputs.RunbookProcessStepRunScriptActionPackageGetArgs> Packages
        {
            get => _packages ?? (_packages = new InputList<Inputs.RunbookProcessStepRunScriptActionPackageGetArgs>());
            set => _packages = value;
        }

        [Input("primaryPackage")]
        public Input<Inputs.RunbookProcessStepRunScriptActionPrimaryPackageGetArgs>? PrimaryPackage { get; set; }
        ...
        public RunbookProcessStepRunScriptActionGetArgs()
        {
        }
        public static new RunbookProcessStepRunScriptActionGetArgs Empty => new RunbookProcessStepRunScriptActionGetArgs();
    }
}
