...
namespace Pulumi.Octopusdeploy
{
    ...
    public sealed class GetDeploymentTargetsArgs : global::Pulumi.InvokeArgs
    {
        [Input("communicationStyles")]
        private List<string>? _communicationStyles;
        ...
        /// </summary>
        public List<string> CommunicationStyles
        {
            get => _communicationStyles ?? (_communicationStyles = new List<string>());
            set => _communicationStyles = value;
        }
        ...
        private List<Inputs.GetDeploymentTargetsDeploymentTargetArgs>? _deploymentTargets;

        /// <summary>
        /// A list of deployment targets that match the filter(s).
        /// </summary>
        public List<Inputs.GetDeploymentTargetsDeploymentTargetArgs> DeploymentTargets
        {
            get => _deploymentTargets ?? (_deploymentTargets = new List<Inputs.GetDeploymentTargetsDeploymentTargetArgs>());
            set => _deploymentTargets = value;
        }
        ...
        public GetDeploymentTargetsArgs()
        {
        }
        public static new GetDeploymentTargetsArgs Empty => new GetDeploymentTargetsArgs();
    }

    public sealed class GetDeploymentTargetsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("communicationStyles")]
        private InputList<string>? _communicationStyles;

        /// <summary>
        /// A filter to search by a list of communication styles. Valid communication styles are `AzureCloudService`, `AzureServiceFabricCluster`, `AzureWebApp`, `Ftp`, `Kubernetes`, `None`, `OfflineDrop`, `Ssh`, `TentacleActive`, or `TentaclePassive`.
        /// </summary>
        public InputList<string> CommunicationStyles
        {
            get => _communicationStyles ?? (_communicationStyles = new InputList<string>());
            set => _communicationStyles = value;
        }
        ...
        [Input("deploymentTargets")]
        private InputList<Inputs.GetDeploymentTargetsDeploymentTargetInputArgs>? _deploymentTargets;

        /// <summary>
        /// A list of deployment targets that match the filter(s).
        /// </summary>
        public InputList<Inputs.GetDeploymentTargetsDeploymentTargetInputArgs> DeploymentTargets
        {
            get => _deploymentTargets ?? (_deploymentTargets = new InputList<Inputs.GetDeploymentTargetsDeploymentTargetInputArgs>());
            set => _deploymentTargets = value;
        }
        ...
        public GetDeploymentTargetsInvokeArgs()
        {
        }
        public static new GetDeploymentTargetsInvokeArgs Empty => new GetDeploymentTargetsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDeploymentTargetsResult
    {
        /// <summary>
        /// A filter to search by a list of communication styles. Valid communication styles are `AzureCloudService`, `AzureServiceFabricCluster`, `AzureWebApp`, `Ftp`, `Kubernetes`, `None`, `OfflineDrop`, `Ssh`, `TentacleActive`, or `TentaclePassive`.
        /// </summary>
        public readonly ImmutableArray<string> CommunicationStyles;
        /// <summary>
        /// A filter to search by deployment ID.
        /// </summary>
        ...
        /// A list of deployment targets that match the filter(s).
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDeploymentTargetsDeploymentTargetResult> DeploymentTargets;
        /// <summary>
        /// A filter to search by a list of environment IDs.
        /// </summary>
        ...
        [OutputConstructor]
        private GetDeploymentTargetsResult(
            ImmutableArray<string> communicationStyles,

            string? deploymentId,

            ImmutableArray<Outputs.GetDeploymentTargetsDeploymentTargetResult> deploymentTargets,
