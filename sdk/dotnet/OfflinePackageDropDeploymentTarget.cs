...
namespace Pulumi.Octopusdeploy
{
    ...
    /// ```
    /// </summary>
    [OctopusdeployResourceType("octopusdeploy:index/offlinePackageDropDeploymentTarget:OfflinePackageDropDeploymentTarget")]
    public partial class OfflinePackageDropDeploymentTarget : global::Pulumi.CustomResource
    {
        [Output("applicationsDirectory")]
        public Output<string> ApplicationsDirectory { get; private set; } = null!;

        [Output("destination")]
        public Output<Outputs.OfflinePackageDropDeploymentTargetDestination> Destination { get; private set; } = null!;

        [Output("endpoints")]
        public Output<ImmutableArray<Outputs.OfflinePackageDropDeploymentTargetEndpoint>> Endpoints { get; private set; } = null!;
        ...
        public OfflinePackageDropDeploymentTarget(string name, OfflinePackageDropDeploymentTargetArgs args, CustomResourceOptions? options = null)
            : base("octopusdeploy:index/offlinePackageDropDeploymentTarget:OfflinePackageDropDeploymentTarget", name, args ?? new OfflinePackageDropDeploymentTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OfflinePackageDropDeploymentTarget(string name, Input<string> id, OfflinePackageDropDeploymentTargetState? state = null, CustomResourceOptions? options = null)
            : base("octopusdeploy:index/offlinePackageDropDeploymentTarget:OfflinePackageDropDeploymentTarget", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OfflinePackageDropDeploymentTarget Get(string name, Input<string> id, OfflinePackageDropDeploymentTargetState? state = null, CustomResourceOptions? options = null)
        {
            return new OfflinePackageDropDeploymentTarget(name, id, state, options);
        }
    }

    public sealed class OfflinePackageDropDeploymentTargetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applicationsDirectory", required: true)]
        public Input<string> ApplicationsDirectory { get; set; } = null!;

        [Input("destination")]
        public Input<Inputs.OfflinePackageDropDeploymentTargetDestinationArgs>? Destination { get; set; }

        [Input("endpoints")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointArgs>? _endpoints;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointArgs>());
        ...
        public OfflinePackageDropDeploymentTargetArgs()
        {
        }
        public static new OfflinePackageDropDeploymentTargetArgs Empty => new OfflinePackageDropDeploymentTargetArgs();
    }

    public sealed class OfflinePackageDropDeploymentTargetState : global::Pulumi.ResourceArgs
    {
        [Input("applicationsDirectory")]
        public Input<string>? ApplicationsDirectory { get; set; }

        [Input("destination")]
        public Input<Inputs.OfflinePackageDropDeploymentTargetDestinationGetArgs>? Destination { get; set; }

        [Input("endpoints")]
        private InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointGetArgs>? _endpoints;
        public InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointGetArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.OfflinePackageDropDeploymentTargetEndpointGetArgs>());
            set => _endpoints = value;
        }
        ...
        public OfflinePackageDropDeploymentTargetState()
        {
        }
        public static new OfflinePackageDropDeploymentTargetState Empty => new OfflinePackageDropDeploymentTargetState();
    }
}
