...
__all__ = ['GcpAccountArgs', 'GcpAccount']

@pulumi.input_type
class GcpAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] json_key: The JSON key associated with this GCP account.
        :param pulumi.Input[str] description: A user-friendly description of this GCP account.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] environments: A list of environment IDs associated with this resource.
        :param pulumi.Input[str] name: The name of this GCP account.
...
class GcpAccount(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GcpAccountArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GcpAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GcpAccountArgs.__new__(GcpAccountArgs)
    ...
    def get(resource_name: str,
            ...
            tenant_tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tenanted_deployment_participation: Optional[pulumi.Input[str]] = None,
            tenants: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'GcpAccount':
        """
        ...
        __props__ = _GcpAccountState.__new__(_GcpAccountState)
        ...
        __props__.__dict__["tenanted_deployment_participation"] = tenanted_deployment_participation
        __props__.__dict__["tenants"] = tenants
        return GcpAccount(resource_name, opts=opts, __props__=__props__)
