...
__all__ = [
    'GetOfflinePackageDropDeploymentTargetsResult',
    'AwaitableGetOfflinePackageDropDeploymentTargetsResult',
    'get_offline_package_drop_deployment_targets',
    'get_offline_package_drop_deployment_targets_output',
]

@pulumi.output_type
class GetOfflinePackageDropDeploymentTargetsResult:
    """
    A collection of values returned by getOfflinePackageDropDeploymentTargets.
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, offline_package_drop_deployment_targets=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        ...
        if offline_package_drop_deployment_targets and not isinstance(offline_package_drop_deployment_targets, list):
            raise TypeError("Expected argument 'offline_package_drop_deployment_targets' to be a list")
        pulumi.set(__self__, "offline_package_drop_deployment_targets", offline_package_drop_deployment_targets)
    ...
    @property
    @pulumi.getter(name="offlinePackageDropDeploymentTargets")
    def offline_package_drop_deployment_targets(self) -> Sequence['outputs.GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetResult']:
        """
        A list of offline package drop deployment targets that match the filter(s).
        """
        return pulumi.get(self, "offline_package_drop_deployment_targets")
...
class AwaitableGetOfflinePackageDropDeploymentTargetsResult(GetOfflinePackageDropDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOfflinePackageDropDeploymentTargetsResult(
            ...
            name=self.name,
            offline_package_drop_deployment_targets=self.offline_package_drop_deployment_targets,
...
def get_offline_package_drop_deployment_targets(deployment_id: Optional[str] = None,
                                                environments: Optional[Sequence[str]] = None,
                                                health_statuses: Optional[Sequence[str]] = None,
                                                ids: Optional[Sequence[str]] = None,
                                                is_disabled: Optional[bool] = None,
                                                name: Optional[str] = None,
                                                offline_package_drop_deployment_targets: Optional[Sequence[pulumi.InputType['GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetArgs']]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOfflinePackageDropDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetArgs']] offline_package_drop_deployment_targets: A list of offline package drop deployment targets that match the filter(s).
    ...
    __args__['name'] = name
    __args__['offlinePackageDropDeploymentTargets'] = offline_package_drop_deployment_targets
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getOfflinePackageDropDeploymentTargets:getOfflinePackageDropDeploymentTargets', __args__, opts=opts, typ=GetOfflinePackageDropDeploymentTargetsResult).value

    return AwaitableGetOfflinePackageDropDeploymentTargetsResult(
        ...
        name=__ret__.name,
        offline_package_drop_deployment_targets=__ret__.offline_package_drop_deployment_targets,
...
@_utilities.lift_output_func(get_offline_package_drop_deployment_targets)
def get_offline_package_drop_deployment_targets_output(deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                       ...
                                                       offline_package_drop_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetOfflinePackageDropDeploymentTargetsOfflinePackageDropDeploymentTargetArgs']]]]] = None,
                                                       ...
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOfflinePackageDropDeploymentTargetsResult]:
    """
    Provides information about existing offline package drop deployment targets.
