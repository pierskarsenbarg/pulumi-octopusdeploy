...
__all__ = [
    'GetListeningTentacleDeploymentTargetsResult',
    'AwaitableGetListeningTentacleDeploymentTargetsResult',
    'get_listening_tentacle_deployment_targets',
    'get_listening_tentacle_deployment_targets_output',
]

@pulumi.output_type
class GetListeningTentacleDeploymentTargetsResult:
    """
    A collection of values returned by getListeningTentacleDeploymentTargets.
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, listening_tentacle_deployment_targets=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        ...
        if listening_tentacle_deployment_targets and not isinstance(listening_tentacle_deployment_targets, list):
            raise TypeError("Expected argument 'listening_tentacle_deployment_targets' to be a list")
        pulumi.set(__self__, "listening_tentacle_deployment_targets", listening_tentacle_deployment_targets)
    ...
    @property
    @pulumi.getter(name="listeningTentacleDeploymentTargets")
    def listening_tentacle_deployment_targets(self) -> Sequence['outputs.GetListeningTentacleDeploymentTargetsListeningTentacleDeploymentTargetResult']:
        """
        A list of listening tentacle deployment targets that match the filter(s).
        """
        return pulumi.get(self, "listening_tentacle_deployment_targets")
...
class AwaitableGetListeningTentacleDeploymentTargetsResult(GetListeningTentacleDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetListeningTentacleDeploymentTargetsResult(
            ...
            listening_tentacle_deployment_targets=self.listening_tentacle_deployment_targets,
            name=self.name,
...
def get_listening_tentacle_deployment_targets(deployment_id: Optional[str] = None,
                                              ...
                                              listening_tentacle_deployment_targets: Optional[Sequence[pulumi.InputType['GetListeningTentacleDeploymentTargetsListeningTentacleDeploymentTargetArgs']]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetListeningTentacleDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetListeningTentacleDeploymentTargetsListeningTentacleDeploymentTargetArgs']] listening_tentacle_deployment_targets: A list of listening tentacle deployment targets that match the filter(s).
    ...
    __args__['listeningTentacleDeploymentTargets'] = listening_tentacle_deployment_targets
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getListeningTentacleDeploymentTargets:getListeningTentacleDeploymentTargets', __args__, opts=opts, typ=GetListeningTentacleDeploymentTargetsResult).value

    return AwaitableGetListeningTentacleDeploymentTargetsResult(
        ...
        listening_tentacle_deployment_targets=__ret__.listening_tentacle_deployment_targets,
        name=__ret__.name,
...
@_utilities.lift_output_func(get_listening_tentacle_deployment_targets)
def get_listening_tentacle_deployment_targets_output(deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                     ...
                                                     listening_tentacle_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetListeningTentacleDeploymentTargetsListeningTentacleDeploymentTargetArgs']]]]] = None,
                                                     ...
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetListeningTentacleDeploymentTargetsResult]:
    """
    Provides information about existing listening tentacle deployment targets.
