...
__all__ = [
    'GetSshConnectionDeploymentTargetsResult',
    'AwaitableGetSshConnectionDeploymentTargetsResult',
    'get_ssh_connection_deployment_targets',
    'get_ssh_connection_deployment_targets_output',
]

@pulumi.output_type
class GetSshConnectionDeploymentTargetsResult:
    """
    A collection of values returned by getSshConnectionDeploymentTargets.
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, ssh_connection_deployment_targets=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        ...
        if ssh_connection_deployment_targets and not isinstance(ssh_connection_deployment_targets, list):
            raise TypeError("Expected argument 'ssh_connection_deployment_targets' to be a list")
        pulumi.set(__self__, "ssh_connection_deployment_targets", ssh_connection_deployment_targets)
    ...
    @property
    @pulumi.getter(name="sshConnectionDeploymentTargets")
    def ssh_connection_deployment_targets(self) -> Sequence['outputs.GetSshConnectionDeploymentTargetsSshConnectionDeploymentTargetResult']:
        """
        A list of SSH connection deployment targets that match the filter(s).
        """
        return pulumi.get(self, "ssh_connection_deployment_targets")
...
class AwaitableGetSshConnectionDeploymentTargetsResult(GetSshConnectionDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSshConnectionDeploymentTargetsResult(
            ...
            skip=self.skip,
            ssh_connection_deployment_targets=self.ssh_connection_deployment_targets,
            take=self.take,
...
def get_ssh_connection_deployment_targets(deployment_id: Optional[str] = None,
                                          ...
                                          ssh_connection_deployment_targets: Optional[Sequence[pulumi.InputType['GetSshConnectionDeploymentTargetsSshConnectionDeploymentTargetArgs']]] = None,
                                          take: Optional[int] = None,
                                          tenant_tags: Optional[Sequence[str]] = None,
                                          tenants: Optional[Sequence[str]] = None,
                                          thumbprint: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSshConnectionDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetSshConnectionDeploymentTargetsSshConnectionDeploymentTargetArgs']] ssh_connection_deployment_targets: A list of SSH connection deployment targets that match the filter(s).
    ...
    __args__['skip'] = skip
    __args__['sshConnectionDeploymentTargets'] = ssh_connection_deployment_targets
    __args__['take'] = take
    __args__['tenantTags'] = tenant_tags
    __args__['tenants'] = tenants
    __args__['thumbprint'] = thumbprint
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getSshConnectionDeploymentTargets:getSshConnectionDeploymentTargets', __args__, opts=opts, typ=GetSshConnectionDeploymentTargetsResult).value

    return AwaitableGetSshConnectionDeploymentTargetsResult(
        ...
        skip=__ret__.skip,
        ssh_connection_deployment_targets=__ret__.ssh_connection_deployment_targets,
        take=__ret__.take,
...
@_utilities.lift_output_func(get_ssh_connection_deployment_targets)
def get_ssh_connection_deployment_targets_output(deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                 ...
                                                 ssh_connection_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSshConnectionDeploymentTargetsSshConnectionDeploymentTargetArgs']]]]] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSshConnectionDeploymentTargetsResult]:
    """
    Provides information about existing SSH connection deployment targets.
