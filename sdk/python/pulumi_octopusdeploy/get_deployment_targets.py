...
__all__ = [
    ...
    'AwaitableGetDeploymentTargetsResult',
    'get_deployment_targets',
    'get_deployment_targets_output',
]

@pulumi.output_type
class GetDeploymentTargetsResult:
    """
    A collection of values returned by getDeploymentTargets.
    """
    def __init__(__self__, communication_styles=None, deployment_id=None, deployment_targets=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        if communication_styles and not isinstance(communication_styles, list):
            raise TypeError("Expected argument 'communication_styles' to be a list")
        pulumi.set(__self__, "communication_styles", communication_styles)
        if deployment_id and not isinstance(deployment_id, str):
            raise TypeError("Expected argument 'deployment_id' to be a str")
        pulumi.set(__self__, "deployment_id", deployment_id)
        if deployment_targets and not isinstance(deployment_targets, list):
            raise TypeError("Expected argument 'deployment_targets' to be a list")
    ...
    @property
    @pulumi.getter(name="communicationStyles")
    def communication_styles(self) -> Optional[Sequence[str]]:
        """
        ...
        """
        return pulumi.get(self, "communication_styles")
    ...
    def deployment_targets(self) -> Sequence['outputs.GetDeploymentTargetsDeploymentTargetResult']:
        """
...
class AwaitableGetDeploymentTargetsResult(GetDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDeploymentTargetsResult(
...
def get_deployment_targets(communication_styles: Optional[Sequence[str]] = None,
                           ...
                           deployment_targets: Optional[Sequence[pulumi.InputType['GetDeploymentTargetsDeploymentTargetArgs']]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeploymentTargetsResult:
    """
    Provides information about existing deployment targets.


    :param Sequence[str] communication_styles: A filter to search by a list of communication styles. Valid communication styles are `AzureCloudService`, `AzureServiceFabricCluster`, `AzureWebApp`, `Ftp`, `Kubernetes`, `None`, `OfflineDrop`, `Ssh`, `TentacleActive`, or `TentaclePassive`.
    :param str deployment_id: A filter to search by deployment ID.
    :param Sequence[pulumi.InputType['GetDeploymentTargetsDeploymentTargetArgs']] deployment_targets: A list of deployment targets that match the filter(s).
    ...
    """
    __args__ = dict()
    __args__['communicationStyles'] = communication_styles
    __args__['deploymentId'] = deployment_id
    __args__['deploymentTargets'] = deployment_targets
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getDeploymentTargets:getDeploymentTargets', __args__, opts=opts, typ=GetDeploymentTargetsResult).value

    return AwaitableGetDeploymentTargetsResult(
        communication_styles=__ret__.communication_styles,
        deployment_id=__ret__.deployment_id,
        deployment_targets=__ret__.deployment_targets,
...
@_utilities.lift_output_func(get_deployment_targets)
def get_deployment_targets_output(communication_styles: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                  deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                  deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetDeploymentTargetsDeploymentTargetArgs']]]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDeploymentTargetsResult]:
    """
    Provides information about existing deployment targets.
