...
class GetCloudRegionDeploymentTargetsResult:
    ...
    """
    def __init__(__self__, cloud_region_deployment_targets=None, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
...
def get_cloud_region_deployment_targets(cloud_region_deployment_targets: Optional[Sequence[pulumi.InputType['GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs']] cloud_region_deployment_targets: A list of cloud region deployment targets that match the filter(s).
    ...
    """
    __args__ = dict()
    __args__['cloudRegionDeploymentTargets'] = cloud_region_deployment_targets
    ...
    return AwaitableGetCloudRegionDeploymentTargetsResult(
        cloud_region_deployment_targets=__ret__.cloud_region_deployment_targets,
...
def get_cloud_region_deployment_targets_output(cloud_region_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetCloudRegionDeploymentTargetsCloudRegionDeploymentTargetArgs']]]]] = None,
