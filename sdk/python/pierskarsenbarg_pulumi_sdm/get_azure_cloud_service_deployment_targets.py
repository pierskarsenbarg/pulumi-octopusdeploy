...
__all__ = [
    'GetAzureCloudServiceDeploymentTargetsResult',
    'AwaitableGetAzureCloudServiceDeploymentTargetsResult',
    'get_azure_cloud_service_deployment_targets',
    'get_azure_cloud_service_deployment_targets_output',
]

@pulumi.output_type
class GetAzureCloudServiceDeploymentTargetsResult:
    """
    A collection of values returned by getAzureCloudServiceDeploymentTargets.
    """
    def __init__(__self__, azure_cloud_service_deployment_targets=None, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        if azure_cloud_service_deployment_targets and not isinstance(azure_cloud_service_deployment_targets, list):
            raise TypeError("Expected argument 'azure_cloud_service_deployment_targets' to be a list")
        pulumi.set(__self__, "azure_cloud_service_deployment_targets", azure_cloud_service_deployment_targets)
    ...
    @property
    @pulumi.getter(name="azureCloudServiceDeploymentTargets")
    def azure_cloud_service_deployment_targets(self) -> Sequence['outputs.GetAzureCloudServiceDeploymentTargetsAzureCloudServiceDeploymentTargetResult']:
        """
        A list of Azure cloud service deployment targets that match the filter(s).
        """
        return pulumi.get(self, "azure_cloud_service_deployment_targets")
...
class AwaitableGetAzureCloudServiceDeploymentTargetsResult(GetAzureCloudServiceDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAzureCloudServiceDeploymentTargetsResult(
            azure_cloud_service_deployment_targets=self.azure_cloud_service_deployment_targets,
...
def get_azure_cloud_service_deployment_targets(azure_cloud_service_deployment_targets: Optional[Sequence[pulumi.InputType['GetAzureCloudServiceDeploymentTargetsAzureCloudServiceDeploymentTargetArgs']]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAzureCloudServiceDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetAzureCloudServiceDeploymentTargetsAzureCloudServiceDeploymentTargetArgs']] azure_cloud_service_deployment_targets: A list of Azure cloud service deployment targets that match the filter(s).
    ...
    """
    __args__ = dict()
    __args__['azureCloudServiceDeploymentTargets'] = azure_cloud_service_deployment_targets
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getAzureCloudServiceDeploymentTargets:getAzureCloudServiceDeploymentTargets', __args__, opts=opts, typ=GetAzureCloudServiceDeploymentTargetsResult).value

    return AwaitableGetAzureCloudServiceDeploymentTargetsResult(
        azure_cloud_service_deployment_targets=__ret__.azure_cloud_service_deployment_targets,
...
@_utilities.lift_output_func(get_azure_cloud_service_deployment_targets)
def get_azure_cloud_service_deployment_targets_output(azure_cloud_service_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAzureCloudServiceDeploymentTargetsAzureCloudServiceDeploymentTargetArgs']]]]] = None,
                                                      ...
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAzureCloudServiceDeploymentTargetsResult]:
    """
    Provides information about existing Azure cloud service deployment targets.
