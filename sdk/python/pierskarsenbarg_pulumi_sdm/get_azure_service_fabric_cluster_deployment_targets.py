...
__all__ = [
    'GetAzureServiceFabricClusterDeploymentTargetsResult',
    'AwaitableGetAzureServiceFabricClusterDeploymentTargetsResult',
    'get_azure_service_fabric_cluster_deployment_targets',
    'get_azure_service_fabric_cluster_deployment_targets_output',
]

@pulumi.output_type
class GetAzureServiceFabricClusterDeploymentTargetsResult:
    """
    A collection of values returned by getAzureServiceFabricClusterDeploymentTargets.
    """
    def __init__(__self__, azure_service_fabric_cluster_deployment_targets=None, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        if azure_service_fabric_cluster_deployment_targets and not isinstance(azure_service_fabric_cluster_deployment_targets, list):
            raise TypeError("Expected argument 'azure_service_fabric_cluster_deployment_targets' to be a list")
        pulumi.set(__self__, "azure_service_fabric_cluster_deployment_targets", azure_service_fabric_cluster_deployment_targets)
    ...
    @property
    @pulumi.getter(name="azureServiceFabricClusterDeploymentTargets")
    def azure_service_fabric_cluster_deployment_targets(self) -> Sequence['outputs.GetAzureServiceFabricClusterDeploymentTargetsAzureServiceFabricClusterDeploymentTargetResult']:
        """
        A list of Azure service fabric cluster deployment targets that match the filter(s).
        """
        return pulumi.get(self, "azure_service_fabric_cluster_deployment_targets")
...
class AwaitableGetAzureServiceFabricClusterDeploymentTargetsResult(GetAzureServiceFabricClusterDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAzureServiceFabricClusterDeploymentTargetsResult(
            azure_service_fabric_cluster_deployment_targets=self.azure_service_fabric_cluster_deployment_targets,
...
def get_azure_service_fabric_cluster_deployment_targets(azure_service_fabric_cluster_deployment_targets: Optional[Sequence[pulumi.InputType['GetAzureServiceFabricClusterDeploymentTargetsAzureServiceFabricClusterDeploymentTargetArgs']]] = None,
                                                        ...
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAzureServiceFabricClusterDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetAzureServiceFabricClusterDeploymentTargetsAzureServiceFabricClusterDeploymentTargetArgs']] azure_service_fabric_cluster_deployment_targets: A list of Azure service fabric cluster deployment targets that match the filter(s).
    ...
    """
    __args__ = dict()
    __args__['azureServiceFabricClusterDeploymentTargets'] = azure_service_fabric_cluster_deployment_targets
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getAzureServiceFabricClusterDeploymentTargets:getAzureServiceFabricClusterDeploymentTargets', __args__, opts=opts, typ=GetAzureServiceFabricClusterDeploymentTargetsResult).value

    return AwaitableGetAzureServiceFabricClusterDeploymentTargetsResult(
        azure_service_fabric_cluster_deployment_targets=__ret__.azure_service_fabric_cluster_deployment_targets,
...
@_utilities.lift_output_func(get_azure_service_fabric_cluster_deployment_targets)
def get_azure_service_fabric_cluster_deployment_targets_output(azure_service_fabric_cluster_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAzureServiceFabricClusterDeploymentTargetsAzureServiceFabricClusterDeploymentTargetArgs']]]]] = None,
                                                               ...
                                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAzureServiceFabricClusterDeploymentTargetsResult]:
    """
    Provides information about existing Azure service fabric cluster deployment targets.
