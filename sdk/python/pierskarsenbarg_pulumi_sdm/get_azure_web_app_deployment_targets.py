...
__all__ = [
    'GetAzureWebAppDeploymentTargetsResult',
    'AwaitableGetAzureWebAppDeploymentTargetsResult',
    'get_azure_web_app_deployment_targets',
    'get_azure_web_app_deployment_targets_output',
]

@pulumi.output_type
class GetAzureWebAppDeploymentTargetsResult:
    """
    A collection of values returned by getAzureWebAppDeploymentTargets.
    """
    def __init__(__self__, azure_web_app_deployment_targets=None, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        if azure_web_app_deployment_targets and not isinstance(azure_web_app_deployment_targets, list):
            raise TypeError("Expected argument 'azure_web_app_deployment_targets' to be a list")
        pulumi.set(__self__, "azure_web_app_deployment_targets", azure_web_app_deployment_targets)
    ...
    @property
    @pulumi.getter(name="azureWebAppDeploymentTargets")
    def azure_web_app_deployment_targets(self) -> Sequence['outputs.GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetResult']:
        """
        A list of Azure web app deployment targets that match the filter(s).
        """
        return pulumi.get(self, "azure_web_app_deployment_targets")
...
class AwaitableGetAzureWebAppDeploymentTargetsResult(GetAzureWebAppDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAzureWebAppDeploymentTargetsResult(
            azure_web_app_deployment_targets=self.azure_web_app_deployment_targets,
...
def get_azure_web_app_deployment_targets(azure_web_app_deployment_targets: Optional[Sequence[pulumi.InputType['GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs']]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAzureWebAppDeploymentTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs']] azure_web_app_deployment_targets: A list of Azure web app deployment targets that match the filter(s).
    ...
    """
    __args__ = dict()
    __args__['azureWebAppDeploymentTargets'] = azure_web_app_deployment_targets
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getAzureWebAppDeploymentTargets:getAzureWebAppDeploymentTargets', __args__, opts=opts, typ=GetAzureWebAppDeploymentTargetsResult).value

    return AwaitableGetAzureWebAppDeploymentTargetsResult(
        azure_web_app_deployment_targets=__ret__.azure_web_app_deployment_targets,
...
@_utilities.lift_output_func(get_azure_web_app_deployment_targets)
def get_azure_web_app_deployment_targets_output(azure_web_app_deployment_targets: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAzureWebAppDeploymentTargetsAzureWebAppDeploymentTargetArgs']]]]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAzureWebAppDeploymentTargetsResult]:
    """
    Provides information about existing Azure web app deployment targets.
