...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `octopusdeploy` with the `NAME` of your provider.
...
- binary: pulumi-resource-octopusdeploy
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-octopusdeploy/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-octopusdeploy_darwin_amd64_v1
│   └── pulumi-resource-octopusdeploy
├── pulumi-octopusdeploy_darwin_arm64
│   └── pulumi-resource-octopusdeploy
├── pulumi-octopusdeploy_linux_amd64_v1
│   └── pulumi-resource-octopusdeploy
├── pulumi-octopusdeploy_linux_arm64
│   └── pulumi-resource-octopusdeploy
├── pulumi-octopusdeploy_windows_amd64_v1
│   └── pulumi-resource-octopusdeploy.exe
└── pulumi-octopusdeploy_windows_arm64
    └── pulumi-resource-octopusdeploy.exe
```
